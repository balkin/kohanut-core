 ...
 * @property Model_Kohanut_Layout   $layout
 * @property boolean                $islink
 * @property boolean                $showmap
 * @property boolean                $shownav
 * @property string                 $title
 * @property string                 $metadesc
 * @property string                 $metakw
 *
 * // Jelly MPTT properties:
 * 
 * @property int                    $lft
 * @property int                    $rgt
 * @property int                    $lvl
...
class Model_Kohanut_Page extends Jelly_Model_MPTT {
	...
	public static function initialize(Jelly_Meta $meta)
	{
		$meta->fields(array(
			...
			'edited' => new Field_Timestamp(array(
			...
			// nav info
			'islink' => new Field_Boolean(array( /*'append_label'=>false,*/
				'default' => FALSE)),
			'shownav' => new Field_Boolean(array( /*'append_label'=>false,*/
				'default' => TRUE)),
			'showmap' => new Field_Boolean(array( /*'append_label'=>false,*/
				'default' => TRUE)),
			...
			// KOHANUT
			'blocks' => new Field_HasMany(array(
				'foreign' => 'kohanut_block.page'
			))
